# Ben was tasked to write a simple Python function to determine whether an input string 
...
def is_dot_separated_ip_address(input_string):
    ...
    if len(dot_separated_words != 4):
        return print("lenght is not a valid size for ip address")
...
# input string has more or less than 4 components, e.g., 4.5.5 or 1.2.3.4.5: 
